...
$\color{#5d783a}{\textsf{⟢ abv ON's drinking age}}$

$\color{#5d783a}{\textsf{⟢ Foot Soldier (PVZ series) and Zoey (L4D) kinnie}}$
...
$\color{#F3EDF7}{\textsf{💬 - i don't put this on}}$

$\color{#3D8DF7}{\textsf{🎭 - same as above}}$

$\color{#FBC15D}{\textsf{🌙 - idle/off-tab, w2i}}$

$\color{#FE4E8A}{\textsf{⛔ - dni or iwc/iwec (depends on pony's name)}}$
...
$\color{#5d783a}{\textsf{⟢ As an adult, I appreciate being left out of drama that doesn't have to do with me.}}$

$\color{#5d783a}{\textsf{⟢ Colour-dropping, copying, taking inspiration from my ponies ❌}}$

$\color{#5d783a}{\textsf{⟢ C+H is always allowed, even if I'm sitting with friends. If it's not in my name, it's most likely an OCs preference.}}$

$\color{#5d783a}{\textsf{⟢ Don't associate me with my friends, please. I don't know everything they do and/or say.}}$
...
$\color{#5d783a}{\textsf{⟢ I'm easier to speak to in whispers as I'm usually off-tab.}}$

$\color{#5d783a}{\textsf{⟢ If I'm bothering you or did something wrong, please tell me. I'd rather know and sort things civilly.}}$
...
$\color{#5d783a}{\textsf{⟢ ScoutSpy shippers}}$

$\color{#5d783a}{\textsf{⟢ SnuffBomb apologists}}$

![](https://file.garden/Z0TC-0mCggxGeVLO/Zombie%20dividerr.png)

<details>
<summary>$\color{#5d783a}{\textsf{IWC/IWEC}}$</summary>

###

$\color{#5d783a}{\textsf{⟢ Enemies-to-lovers ships (I dislike it most of the time)}}$

$\color{#5d783a}{\textsf{⟢ Forsaken, Mouthwashing}}$

$\color{#5d783a}{\textsf{⟢ Political talk}}$

$\color{#5d783a}{\textsf{⟢ Religious talk (I've had Christianity attempted to be shoved down my throat before)}}$
